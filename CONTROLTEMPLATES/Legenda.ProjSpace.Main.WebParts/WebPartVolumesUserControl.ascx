...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebPartVolumesUserControl.ascx.cs" Inherits="Legenda.ProjSpace.Main.CONTROLTEMPLATES.Legenda.ProjSpace.Main.WebParts.WebPartVolumesUserControl" %>
...
<script src="../../_layouts/15/Legenda.ProjSpace.Main/js/JsGridWritebackManager.js?v=20260414" type="text/javascript"></script>
<SharePoint:JSGrid ID="JsGridControl" runat="server" JSControllerClassName="WritebackGridManager" JSControllerInstanceName="WGM" EnableViewState="true" ViewStateMode="Enabled" />
